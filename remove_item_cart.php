...
session_start();
	...
	echo $id_t;
			...
			//REDUCE CART PRICE TO NULL, Parmar dhyey
			...
			WHERE p_id = $id_t AND user_name='$us_name' ") 
				...
				//UPDATE CART PRICE, Parmar dhyey
					...
					//REDUCE CART QUANTITY TO NULL, Parmar dhyey
				$sql = $conn->query("SELECT u_cart.p_id, u_cart.user_name, u_cart.u_qty,
										i_new_product.id, i_new_product.price,
		...
		//Cart QUANTITY Calculation, Created Parmar dhyey
							...
							//REMOVE ITEM FROM CART, Parmar dhyey
